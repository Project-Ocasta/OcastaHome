...
const LandingTiles = ({
  ...
  const sectionHeader = {
    ...
    paragraph: 'Each person is placed in a different group based on their skills and interests. You will be able to work on large team projects while contributing what you are best at.'
  };
...
LandingTiles.propTypes = propTypes;
LandingTiles.defaultProps = defaultProps;
